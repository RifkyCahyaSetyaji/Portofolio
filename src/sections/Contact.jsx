      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
            <div className="glass-card p-8 rounded-3xl flex-grow flex flex-col justify-center">
              <h3 className="text-xl font-bold text-brand-primary dark:text-brand-accent mb-2">Let's Discuss</h3>
              <p className="text-xs sm:text-sm text-brand-dark/75 dark:text-brand-textDark/75 leading-relaxed mb-8">
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="p-3.5 bg-brand-primary/10 dark:bg-brand-accent/10 text-brand-primary dark:text-brand-accent rounded-xl">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <input
                          ...
                          className={`w-full px-4.5 py-3 rounded-xl bg-white/60 dark:bg-brand-bgDark/60 border text-sm focus:outline-none focus:ring-2 transition-all ${
                            errors.name
                      ...
                      <div className="flex flex-col">
                        ...
                        <textarea
                          ...
                          className={`w-full px-4.5 py-3 rounded-xl bg-white/60 dark:bg-brand-bgDark/60 border text-sm focus:outline-none focus:ring-2 transition-all resize-none ${
                            errors.message
                              ? 'border-red-500 focus:ring-red-500/20'
                              : 'border-brand-primary/10 dark:border-brand-accent/10 focus:border-brand-primary dark:focus:border-brand-accent focus:ring-brand-primary/20 dark:focus:ring-brand-accent/20'
                          }`}
